jQuery(function ($) {
  $().ready(function () {
    ...
    function redirect() {
      ...
      const tipo_vehiculo = $("#tipo_de_vehiculo").val();
      const nombre = $("#nombre_booking").val();
      const apellido = $("#apellido_booking").val();
      const email = $("#email_booking").val();
      const patente = $("#patente_booking").val();
      const telefono = $("#telefono_booking").val();
      const turno = $("#nro_turno_booking").val();
      const token = $("#tokenRef").val();
